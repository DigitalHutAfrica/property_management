...
# Part of Digital Hut Africa. See LICENSE file for full copyright and licensing details.
{
    ...
    "description": """
        ...
        - Property List
    """,
    "summary": "Property Sale & Property Management",
    "version": "18.0.6.4",
    ...
    "data": [
        ...
        "wizard/maintenance_rejection_view.xml",
        ...
        "views/rent_passthrough_view.xml",
        "data/accounting_products.xml",
        "views/accounting_split_view.xml",
        "views/maintenance_cost_view.xml",
        "views/property_vendor_view.xml",
        # Menus (last — depends on all views)
        "views/maintenance_approval_view.xml",
