...
class PropertyDetails(models.Model):
    ...
    def action_property_management_agreement(self):
        for rec in self:
            view = self.env.ref('property_management.tenancy_details_form_view')
            ctx = {
...
class ParentProperty(models.Model):
    ...
    def send_property_report_mail(self):
        ...
        mail_template = self.env.ref(
            "property_management.property_wise_occupancy_report_mail").sudo()
        ...
        mail_values = {
            'email_to': self.env['ir.config_parameter'].sudo().get_param(
                'property_management.property_report_mails'),
